...
export const en: Locale = {
  ...
  'ifsBrowser.moveIFS.errorMessage': `Error beim umbenennen/verschieben von {0}! {1}`,
  ...
  'ifsBrowser.copyIFS.infoMessage': `{0} wurde nach {1} kopiert.`,
  'ifsBrowser.copyIFS.errorMessage': `Error beim kopieren von {0}! {1}`,
  'ifsBrowser.searchIFS.prompt': `Enter IFS directory to search`,
  'ifsBrowser.searchIFS.title': `Search directory`,
  'ifsBrowser.searchIFS.title2': `{0} durchsuchen`,
  ...
  'ifsBrowser.downloadStreamfile.downloading':'Ddownload im gange',  
  'ifsBrowser.downloadStreamfile.complete': `Download fertiggestellt`,
  'ifsBrowser.downloadStreamfile.errorMessage': `Error beim downloaden von: {0} Datei(en)`,
  'ifsBrowser.getChildren.errorMessage': `Error beim Laden von Objekten.`,
  'ifsBrowser.handleFileListErrors.errorMessage': `{0} {1} ist beim Auflisten von Dateien aufgetreten.`,
  'ifsBrowser.doSearchInStreamfiles.title': `suchen`,
